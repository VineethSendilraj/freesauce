    ...
    <div className="group relative bg-card rounded-3xl border border-border hover:border-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden h-full">
      <div className="p-6 flex flex-col h-full">
        ...
        <Button
          ...
          className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2.5 text-xs font-semibold rounded-xl transition-all duration-200 w-full shadow-lg hover:shadow-xl"
        >
          Apply Now
        </Button>
      </div>

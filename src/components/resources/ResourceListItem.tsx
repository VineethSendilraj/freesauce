...
const ResourceListItem = ({ resource }: ResourceListItemProps) => {
  ...
  return (
    <div className="group bg-card border border-border hover:border-border/60 hover:shadow-sm transition-all duration-200 rounded-lg overflow-hidden">
      <div className="p-3">
        <div className="grid grid-cols-12 gap-4 items-center">
          ...
          <div className="col-span-1 text-center">
            {resource.value && (
              <span className="text-sm font-semibold text-card-foreground bg-muted px-3 py-1.5 rounded-lg">
                {resource.value}
              </span>
            )}
          </div>
          ...
          <div className="col-span-1 flex justify-center">
            <Button 
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 text-sm font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200"
            >
              Apply
            </Button>
          </div>
